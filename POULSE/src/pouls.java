...
public class pouls {
    ...
    pouls() {
        ...
        ImageIcon background_Imageskk = new ImageIcon(
                "C:\\Users\\esamm\\OneDrive\\Documents\\POULSE\\src\\Puls.jpg.png");
        ...
        nam.setVisible(true);
        login.add(nam);
        ImageIcon background_Image = new ImageIcon("C:\\Users\\esamm\\OneDrive\\Documents\\POULSE\\src\\oo.jpg");
        ...
        button1.setFocusPainted(false); // Remove the default focus border
        ...
        button2.addActionListener(e -> {
            ...
            ImageIcon background_Imagessd = new ImageIcon("C:\\Users\\esamm\\OneDrive\\Documents\\POULSE\\src\\oo.jpg");
            ...
            loginndd.add(bla);
            ImageIcon background_Imagesnd = new ImageIcon(
                    "C:\\Users\\esamm\\OneDrive\\Documents\\POULSE\\src\\docto.png");
            ...
            DocumentListener documentListener = new DocumentListener() {
                ...
                public void checkText() {
                    ...
                    if (text1.isEmpty() || text2.isEmpty() || text3.isEmpty() || text4.isEmpty() || text5.isEmpty()
                            || text7.isEmpty() || password12.length == 0 || text13.isEmpty()) {
                        buttonq.setEnabled(false);
            ...
            buttonq.addActionListener(q -> {
                ...
                gg.setVisible(true);
                ImageIcon background_Imagessqr = new ImageIcon(
                        "C:\\Users\\esamm\\OneDrive\\Documents\\POULSE\\src\\oo.jpg");
                ...
                ppp.add(esammmMm);
                ImageIcon background_Imagesnjt = new ImageIcon(
                        "C:\\Users\\esamm\\OneDrive\\Documents\\POULSE\\src\\hj.png");
                ...
                ppp.add(esammmMmmm);
                ImageIcon background_Imagesnjtt = new ImageIcon(
                        "C:\\Users\\esamm\\OneDrive\\Documents\\POULSE\\src\\hj.png");
        ...
        button3.addActionListener(e -> {
            ...
            ImageIcon background_Imagess = new ImageIcon("C:\\Users\\esamm\\OneDrive\\Documents\\POULSE\\src\\oo.jpg");
            ...
            ImageIcon background_Imagesn = new ImageIcon("C:\\Users\\esamm\\OneDrive\\Documents\\POULSE\\src\\cc.png");
            ...
            JTextField passwordn = new JTextField(17);
            passwordn.setBounds(470, 110, 200, 30);
            passwordn.setText("Please enter 17 digit number");
            ...
            passwordn.addKeyListener(new KeyAdapter() {
                @Override
                public void keyReleased(KeyEvent e) {
                    String text = passwordn.getText();
                    if (text.length() == 17) {
                    } else {
                        buttonn.setEnabled(false);
                    }
            ...
            DocumentListener documentListener = new DocumentListener() {
                ...
                public void checkText() {
                    ...
                    if (text1.isEmpty() || text2.isEmpty() || text3.isEmpty() || text4.isEmpty() || text5.isEmpty()
                            ...
                            || password10.length == 0 || text12.isEmpty()) {
                        buttonn.setEnabled(false);
                    } else {
            ...
            buttonn.addActionListener(j -> {
                ...
                ggd.setVisible(true);
                ImageIcon background_Imagessss = new ImageIcon(
                        "C:\\Users\\esamm\\OneDrive\\Documents\\POULSE\\src\\oo.jpg");
                ...
                ImageIcon background_Imagesnj = new ImageIcon(
                        "C:\\Users\\esamm\\OneDrive\\Documents\\POULSE\\src\\patient pulse .png");
